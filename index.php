...
<body>
    ...
    <?php
        // ПРОГРАММА НАХОДИТ СЛОВА, ВВЕДЕНЫЕ В ПОСКОВУЮ СТРОКУ, ПОЛЬЗОВАТЕЛЕМ.
        // КАЖДОЕ СЛОВО ИЩЕТСЯ ИДНИВИДУАЛЬНО.
        // ЕСЛИ СЛОВОСОЧЕТАНИЕ НАХОДИТСЯ В КАВЫЧКАХ, ПО ОНО ИЩЕТСЯ, КАК ЕДИНСТВЕННОЕ ВХОЖДЕНИЕ
